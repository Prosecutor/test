    ...
    public class MinilandPacketHandler : IPacketHandler
    {
        ...
        public void MinilandAddObject(AddObjPacket addObjPacket)
        {
            ItemInstance minilandobject =
                Session.Character.Inventory.LoadBySlotAndType<ItemInstance>(addObjPacket.Slot, InventoryType.Miniland);
        ...
        {
            ItemInstance minilandobject =
                Session.Character.Inventory.LoadBySlotAndType<ItemInstance>(packet.Slot, InventoryType.Miniland);
            if (minilandobject != null)
            {
                if (Session.Character.MinilandState == MinilandState.Lock)
                {
        ...
        public void UseMinilandObject(UseobjPacket packet)
        {
            ...
            ItemInstance minilandObjectItem =
                client?.Character.Inventory.LoadBySlotAndType<ItemInstance>(packet.Slot, InventoryType.Miniland);
